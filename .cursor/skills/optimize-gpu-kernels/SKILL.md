...
Read [USER-RULES.md](USER-RULES.md) FIRST: explicit user-mandated standing
rules that override everything below. Then read [BASELINES.md](BASELINES.md)
and [REPORTING.md](REPORTING.md) before implementing or reporting results.
