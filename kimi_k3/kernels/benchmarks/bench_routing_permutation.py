...
Run inside the TRT-LLM container with exactly one visible GPU:
  CUDA_VISIBLE_DEVICES=0 python3 kimi_k3/kernels/bench_routing_permutation.py --quick
"""
...
from kimi_k3.kernels.routing_permutation_impls import (
    CANDIDATE,
    DEFAULT,
    FORK,
    SUPPLEMENTAL,
...
def main() -> int:
    ...
    parser.add_argument(
        "--json",
        type=Path,
        default=_REPO / "kimi_k3/local_result/routing_permutation_bench.json",
    )
