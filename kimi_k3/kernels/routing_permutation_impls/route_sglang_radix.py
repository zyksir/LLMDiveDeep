...
from kimi_k3.kernels.routing_permutation import NUM_EXPERTS, TOP_K, Prepared
...
def load() -> None:
    from kimi_k3.kernels.routing_radix import warmup

    warmup()


def prepare(batch: int, device, *, logits=None, bias=None, **_) -> Prepared:
    from kimi_k3.kernels.routing_radix import route_radix_into
