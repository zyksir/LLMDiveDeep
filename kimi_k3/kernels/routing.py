...
Honest accounting (kernels/benchmarks/bench_routing.py, B200) - on clean fp32
...
# at 4k tokens, builtin -10% at 8k. See kernels/benchmarks/bench_routing.py.
...
def _radix_module():
    ...
    if _RADIX_MODULE is None:
        from kimi_k3.kernels.routing_radix import load_radix_module
