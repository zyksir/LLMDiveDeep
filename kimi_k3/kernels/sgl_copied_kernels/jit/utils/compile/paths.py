...
from kimi_k3.kernels.sgl_copied_kernels.jit.utils.common import cache_once


@cache_once
def _resolve_kernel_path() -> pathlib.Path:
    spec = importlib.util.find_spec("kimi_k3.kernels.sgl_copied_kernels.jit")
    ...
    raise RuntimeError("Cannot find kimi_k3.kernels.sgl_copied_kernels.jit path")
