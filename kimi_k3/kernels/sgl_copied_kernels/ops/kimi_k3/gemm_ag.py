...
:func:`kimi_k3.kernels.sgl_copied_kernels.ops.kimi_k3.all_reduce.register_comm` once beforehand
...
from kimi_k3.kernels.sgl_copied_kernels.jit.utils import (
    cache_once,
    is_arch_support_pdl,
    load_jit,
    make_cpp_args,
)
from kimi_k3.kernels.sgl_copied_kernels.ops.kimi_k3.all_reduce import _COMM_MAP
from kimi_k3.kernels.sgl_copied_kernels._sgl_shims.custom_op import register_custom_op
