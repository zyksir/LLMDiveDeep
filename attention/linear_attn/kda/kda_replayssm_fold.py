...
# Vendored from SGLang PR #32541 (kimi-k3 branch, commit 4051b19):
#   python/sglang/kernels/ops/attention/fla/kda_replayssm_spec_decode.py
# Trimmed: `commit_kda_replayssm_after_verify` (imports the sglang runtime) is
# dropped; the Triton fold kernel and its two launch wrappers are verbatim.
# This is the scheme-2.1 "exact fold" commit kernel benched by
# bench_kda_spec_verify.py; see KDA.md section 2.
